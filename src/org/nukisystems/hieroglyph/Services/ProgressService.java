...
public class ProgressService extends Service {
    ...
    public static final String ACTION_PROGRESS_NOTIFICATION = "org.nukisystems.hieroglyph.PROGRESS_NOTIFICATION";
    public static final String ACTION_PROGRESS_REMOVED = "org.nukisystems.hieroglyph.PROGRESS_REMOVED";
    ...
    private MediaController getActiveMediaController() {
        try {
            ComponentName notificationListener = new ComponentName(mContext, 
                org.nukisystems.hieroglyph.Services.NotificationService.class);
